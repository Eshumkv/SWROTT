...
public class FightHelper {
    ...
    /**
     * Returns a {@link be.thomasmore.swrott.data.Stats} that is correct for the
     * specified level.
     ...
     * @return FightOutcome The outcome of the fight. {@link be.thomasmore.swrott.data.FightOutcome}
     */
